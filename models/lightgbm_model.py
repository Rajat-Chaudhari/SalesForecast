...
def build_lightgbm(train_data, target_col, model_config):
    """Build and fit the LightGBM model."""
...
def run_lightgbm(model_name,train_data, test_data, target_col, params):
    """Run lightgbm model."""
    ...
    try:
        ...
        for params in combinations:
            ...
            with mlflow.start_run(experiment_id=experiment.experiment_id) as run:
                ...
                fitted_model,X_train, X_test, y_train, y_test = build_lightgbm(train_data, target_col, params)
...
#     # Build and fit the LightGBM model
#     model, X_train, X_val, y_train, y_val = build_lightgbm(df, 'RS_Actual', model_config)
