...
def build_enr(train_data, target_col, model_config):
    """Build and fit the ElasticNet Regressor."""
...
def run_enr(model_name,train_data, test_data, target_col, params):
    ...
    try:
        ...
        for params in combinations:
            ...
            with mlflow.start_run(experiment_id=experiment.experiment_id) as run:
                ...
                fitted_model,X_train, X_test, y_train, y_test = build_enr(train_data, target_col, params)
...
#     model, X_train, X_test, y_train, y_test = build_elasticnet_regressor(df, 'RS_Actual', model_config)
