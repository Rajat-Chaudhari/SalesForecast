...
def build_xgboost(train_data, target_col, model_config):
...
def run_xgboost(model_name,train_data, test_data, target_col, params):
    """Run XGBoost model."""
    try:
        ...
        for params in combinations:
            ...
            with mlflow.start_run(experiment_id=experiment.experiment_id) as run:
                ...
                fitted_model,X_train, X_test, y_train, y_test = build_xgboost(train_data, target_col, params)
...
#     # Build and fit the XGBoost model
#     model, X_train, X_test, y_train, y_test = build_xgboost(df, 'RS_Actual', model_config)
