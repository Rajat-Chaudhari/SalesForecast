...
def build_rf(train_data, target_col, model_config):
...
def run_rf(model_name,train_data, test_data, target_col, params):
    """Run RF model."""
    ...
    try:
        ...
        for params in combinations:
            ...
            with mlflow.start_run(experiment_id=experiment.experiment_id) as run:
                ...
                fitted_model,X_train, X_test, y_train, y_test = build_rf(train_data, target_col, params)
                ...
                save_performance_metrics(actual_train_lst, actual_test_lst, prediction_train_lst, 
                                        prediction_test_lst,model_name,params,run_id)
...
def forecast_future(model, last_data, periods):
    ...
    for _ in range(periods):
        ...
        # Shift input data with new prediction
...
#     model, X_train, X_test, y_train, y_test = build_random_forest_regressor(df, 'RS_Actual', model_config)
