...
def build_arima(train_data, target_col, model_config):
...
def run_arima(model_name,train_data, test_data, target_col, params):
    """Run ARIMA model."""
    try:
        ...
        for params in combinations:
            ...
            with mlflow.start_run(experiment_id=experiment.experiment_id) as run:
                ...
                fitted_model = build_arima(train_data, target_col, params)
